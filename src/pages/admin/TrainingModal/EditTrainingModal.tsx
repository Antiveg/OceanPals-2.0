...
const EditTrainingModal: React.FC<{ isOpen: boolean; onClose: () => void; fetchData: () => void; trainingData: any }> = ({ isOpen, onClose, fetchData, trainingData }) => {
    ...
    useEffect(() => {
        if (isOpen) {
            setFormData({
                ...
                shortDescription: trainingData.shortDescription,
                fullDescription: trainingData.fullDescription,
                image: trainingData.image,
                authorName: trainingData.authorName,
                authorImage: trainingData.authorImage,
                authorPosition: trainingData.authorPosition,
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            const trainingRef = doc(db, 'Training', trainingData.id);
        ...
        <div className="fixed inset-0 flex items-center justify-center z-50 text-left">
            ...
            <div className="relative bg-gray-800 rounded-lg shadow-lg p-6 max-w-lg w-full mx-auto max-h-[90%] overflow-y-auto">
                <div className="flex items-center justify-between mb-4">
                    <h3 className="text-lg font-semibold text-gray-100">Edit Training</h3>
                    <button 
                        type="button" 
