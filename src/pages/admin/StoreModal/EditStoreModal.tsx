...
const EditStoreModal: React.FC<{ isOpen: boolean; onClose: () => void; fetchData: () => void; storeData: any; }> = ({ isOpen, onClose, fetchData, storeData }) => {
        ...
        <div className="fixed inset-0 flex items-center justify-center z-50">
            ...
            <div className="relative bg-gray-800 rounded-lg shadow-lg p-6 max-w-lg w-full mx-auto">
                <div className="flex items-center justify-between mb-4">
                    <h3 className="text-lg font-semibold text-gray-100">Edit Store</h3>
                    <button
                        type="button"
